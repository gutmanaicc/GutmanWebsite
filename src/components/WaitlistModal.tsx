    ...
    <AnimatePresence>
      {isOpen && target ? (
        ...
        >
          ...
          <motion.div
            ref={panelRef}
            className="relative z-10 flex max-h-[92vh] w-full max-w-md flex-col overflow-hidden rounded-t-[1.75rem] bg-[#141318] text-bone ring-1 ring-white/10 shadow-float sm:rounded-[1.75rem]"
