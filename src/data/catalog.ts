// קטלוג המסלולים והסדנאות המלא של האקדמיה, לפי הרשימה של רון (8.2026).
...
export const CATALOG: CatalogEntry[] = [
  ...
  {
    slug: "fashion-ai-lab",
    title: "The Fashion AI Lab · AI לאופנה",
    blurb:
      "מסלול סביב יצירת מותג וקמפיין אופנה באמצעות AI: קונספט, שפה ויזואלית, קולקציה, תמונות מוצר וקמפיין, תוכן ויצירת נכסים למותג.",
  ...
  },
  {
    ...
    title: "AI למפתחים",
    blurb:
      "שימוש בכלי AI בתהליך הפיתוח: כתיבת קוד, פתרון בעיות, בניית פיצ'רים, עבודה עם סוכנים וכלי AI שמאיצים את תהליך הפיתוח.",
    category: "פיתוח",
    kind: "מסלול",
    full: false,
  },
  {
    ...
    title: "CRM עם AI",
    blurb:
      "בנייה וניהול של מערכת CRM חכמה: לידים, לקוחות, סטטוסים, פולואפים, מידע עסקי ואוטומציות בעזרת AI.",
    category: "ניהול עסק",
    kind: "סדנה",
    full: false,
    parent: "ai-business-systems",
  },
  {
    slug: "ai-invoices-admin",
    title: "חשבוניות וניהול אדמיניסטרטיבי עם AI",
    blurb:
      "ייעול הפעולות האדמיניסטרטיביות בעסק: מסמכים, חשבוניות, ניהול מידע, מעקבים ותהליכים שחוזרים על עצמם.",
    category: "ניהול עסק",
    kind: "סדנה",
    full: false,
    parent: "ai-business-systems",
  ...
  {
    slug: "ai-for-organizations",
    title: "AI לארגונים וחברות",
    blurb:
      "סדנה שמותאמת לארגון ולצוותים שלו ומלמדת איך להטמיע AI בתהליכי העבודה הקיימים, לפי המחלקות והצרכים של החברה.",
    category: "ארגונים וצוותים",
    kind: "סדנה",
    full: false,
  },
];
