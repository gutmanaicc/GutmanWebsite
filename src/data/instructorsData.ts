...
export const INSTRUCTORS: Instructor[] = [
  {
    ...
    trackBios: {
      ...
      video:
        "במסלול עורכי הווידאו ויוצרי התוכן, רון מוביל תהליך הפקה מבוסס AI - מקונספט ותסריט ועד שוטים, עריכה ותוצר מסחרי שניתן לשחזר בכל פרויקט.",
  ...
  },
  {
    ...
    name: "הדר בן דור",
    shortName: "הדר",
    role: "צלמת אופנה ומסחרית",
    roleTags: ["צילום אופנה", "מסחרי", "ויז'ואל"],
    ...
    bio: "הדר בן דור היא צלמת אופנה ומסחרית עם רקע משנקר ומעולם האופנה הישראלי. היא מביאה לאקדמיה עין ויזואלית חדה, סטנדרט מסחרי, והבנה עמוקה של איך בונים שפה תמונתית שעובדת גם עם כלי AI.",
    trackBios: {
      general:
        "הדר מביאה סטנדרט ויזואלי מסחרי לתוך תהליכי יצירה עם AI - קומפוזיציה, אור, טון מותג ותוצאה שנראית מקצועית מהפריים הראשון.",
      video:
        "במסלול הווידאו והתוכן, הדר מחזקת את השכבה הוויזואלית: איך בונים שפה תמונתית עקבית, שוטים ברמה מסחרית, וטון מותג שלא נשבר בין פריימים.",
    },
  },
  {
    id: "idan-mansur",
