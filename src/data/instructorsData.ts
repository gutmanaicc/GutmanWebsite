...
/*
 * סדר המערך הוא סדר התצוגה בסקשן המנחים, והוא מסודר לפי גוון הפורטרט
 * כדי שהחולצות הבהירות והכהות יתחלפו ולא יתקבצו בצד אחד:
 * רון (בהיר) · הדר (כהה) · נופר (בהיר) · עידן (כהה) · ואז השאר.
 * מתוך שבעה פורטרטים רק שניים בחולצה בהירה, ולכן ההתחלפות מלאה
 * לאורך ארבעת הראשונים בלבד. מנחה חדש עם חולצה בהירה - כדאי לשלב
 * אותו בין הכהים ולא להוסיף בסוף.
 */
export const INSTRUCTORS: Instructor[] = [
  ...
  },
  {
    ...
    shortName: "אבישי",
    role: "מנחה סדנת ADHD",
    roleTags: ["ADHD", "פרויקטור עסקי", "תהליכי עבודה"],
    image: "/images/instructors/Avishay_Gordon.jpg",
    credentials: [
      "פרויקטור עסקי, עשור של עבודה עם חברות, עסקים וארגונים",
      "מנחה הפודקאסט \"כל אדם יזם\"",
      "מוביל תוכן וכנסים בנושא ADHD",
    ],
    bio: "אבישי גורדון הוא פרויקטור עסקי עם עשור של עבודה עם חברות, עסקים וארגונים, ומנחה הפודקאסט \"כל אדם יזם\". ADHD הוא חלק מרכזי בעשייה שלו, והוא עוסק בחיבור שבין קשב וריכוז לבין בניית תהליכי עבודה שבאמת מחזיקים לאורך זמן.",
    trackBios: {
      general:
        "אבישי מביא לאקדמיה מבט של מי שבונה תהליכי עבודה בעסקים, ומתרגם אותו לעבודה עם קשב וריכוז: פחות תלות בכוח רצון, יותר מבנה שעובד גם ביום פחות טוב.",
      adhd:
        "בסדנת ה-ADHD, אבישי עובד עם המשתתפים על שימוש בבינה מלאכותית ככלי שמייצר סדר, מפרק משימות גדולות לצעדים ברורים, ומחזיק את הרצף גם כשהקשב נשבר.",
    },
  },
];
